...
--
-- Hôte : localhost:8889
-- Généré le :  ven. 10 mai 2019 à 00:52
...
--
ALTER TABLE `bills`
  ADD CONSTRAINT `bills_user_id` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`);

--
-- Contraintes pour la table `events`
--
ALTER TABLE `events`
  ADD CONSTRAINT `events category_id` FOREIGN KEY (`category_id`) REFERENCES `categories` (`id`),
  ADD CONSTRAINT `events_address_id` FOREIGN KEY (`address_id`) REFERENCES `addresses` (`id`);

--
-- Contraintes pour la table `events_medias`
--
ALTER TABLE `events_medias`
  ADD CONSTRAINT `em_media_id` FOREIGN KEY (`media_id`) REFERENCES `events` (`id`),
  ADD CONSTRAINT `event_id` FOREIGN KEY (`event_id`) REFERENCES `events` (`id`);

--
-- Contraintes pour la table `medias_services`
--
ALTER TABLE `medias_services`
  ADD CONSTRAINT `ms_media_id` FOREIGN KEY (`media_id`) REFERENCES `medias` (`id`),
...
--
ALTER TABLE `services`
  ADD CONSTRAINT `services_address_id` FOREIGN KEY (`address_id`) REFERENCES `addresses` (`id`);

--
-- Contraintes pour la table `users`
--
ALTER TABLE `users`
  ADD CONSTRAINT `users_address_id` FOREIGN KEY (`address_id`) REFERENCES `addresses` (`id`);
